    ...
    <section className="portfolio">
      ...
      <ul className="portfolio__list">
        <li className="portfolio__link">
          <a className="portfolio__link-item" href="https://sia-kutyreva.github.io/how-to-learn/" target="blank">Статичный сайт
            <img className="portfolio__link-img" alt="стрелка" src={arrow} />
          </a>
        </li>
        <li className="portfolio__link">
          <a className="portfolio__link-item" href="https://sia-kutyreva.github.io/russian-travel/" target="blank">Адаптивный сайт
            <img className="portfolio__link-img" alt="стрелка" src={arrow} />
          </a>
        </li>
        <li className="portfolio__link">
